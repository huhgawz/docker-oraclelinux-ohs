...
5. Build the image: `$ docker build --rm --tag=oraclelinux-ohs .` (behind a proxy: `$ docker build --build-arg http_proxy=http://<proxy-host>:<proxy-port> --rm --tag=oraclelinux-ohs .` )
